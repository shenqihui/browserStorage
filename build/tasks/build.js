...
module.exports = function( grunt ) {
	...
	function convert( name, path, contents ) {
		...
		if ( (amdName = grunt.option( "amd" )) != null && /^exports\/amd$/.test( name ) ) {
			...
			contents = contents
				.replace( /(\s*)"browserStorage"(\,\s*)/, amdName ? "$1\"" + amdName + "\"$2" : "" );
	...
	function() {
		...
		if ( !optIn ) {
			...
			config.rawText.browserStorage = "define([" + (included.length ? included.join(",") : "") + "]);";
		}
